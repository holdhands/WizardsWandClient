...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void wakeUpPlayer(boolean immediately, boolean updateWorldFlag, boolean setSpawn)
    {
        ...
        {
            this.worldObj.setBlockState(this.bedLocation, iblockstate.withProperty(BlockBed.OCCUPIED, Boolean.valueOf(false)), 4);
            BlockPos blockpos = BlockBed.getSafeExitLocation(this.worldObj, this.bedLocation, 0);
    ...
    {
        return this.worldObj.getBlockState(this.bedLocation).getBlock() == Blocks.BED;
    }
    ...
    public float getBedOrientationInDegrees()
    {
        ...
        {
            EnumFacing enumfacing = (EnumFacing)this.worldObj.getBlockState(this.bedLocation).getValue(BlockHorizontal.FACING);
