...
public class EntityZombie extends EntityMob
{
    ...
    {
        if (this.worldObj.isDaytime() && !this.worldObj.isRemote && !this.isChild() && this.getZombieType().isSunSensitive())
        {
    ...
    {
        SoundEvent soundevent = this.getZombieType().getStepSound();
    ...
    public void writeEntityToNBT(NBTTagCompound compound)
    {
        ...
        compound.setInteger("ZombieType", this.getZombieType().getId());
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        if (compound.getBoolean("IsVillager"))
        {
            ...
            {
                this.setZombieType(ZombieType.getByOrdinal(compound.getInteger("VillagerProfession") + 1));
            }
            else
            {
                this.setZombieType(ZombieType.getByOrdinal(this.worldObj.rand.nextInt(5) + 1));
            }
        }

        if (compound.hasKey("ZombieType"))
        {
            this.setZombieType(ZombieType.getByOrdinal(compound.getInteger("ZombieType")));
        }
